...
import { ConsoleManager } from "../../ConsoleGui"
import PageBuilder from "../PageBuilder"
import DoubleLayout, { DoubleLayoutOptions } from "./DoubleLayout"
import QuadLayout, { QuadLayoutOptions } from "./QuadLayout"
import SingleLayout, { SingleLayoutOptions } from "./SingleLayout"
...
export interface LayoutOptions {
    showTitle?: boolean;
    boxed?: boolean;
    boxColor?: typeof ForegroundColor | ""; // add color list from chalk
    boxStyle?: "bold";
        ...
        if (this.instance) {
            ...
            case "quad":
                this.optionsRelative = {
                    ...
                    pageRatio: this.options.pageRatio as unknown as [[number, number], [number, number]],
