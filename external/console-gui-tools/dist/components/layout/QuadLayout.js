 ...
 */
class QuadLayout {
    constructor(page1, page2, page3, page4, options, selected = 0) {
        this.realWidth = [[0, 0], [0, 0]];
     ...
     * @returns {void}
     */
    drawLine(line, secondLine, row = 0) {
        ...
        if (this.options.boxed)
            ret.push({ text: "│", style: { color: this.selected === 0 && row === 0 || this.selected === 2 && row === 1 ? this.options.boxColor : "white", bold: this.boxBold } });
        ret.push(...newLine[0]);
        ...
        if (this.options.boxed)
            ret.push({ text: "│", style: { color: ((this.selected < 2 && row === 0) || (this.selected > 1 && row === 1)) ? this.options.boxColor : "white", bold: this.boxBold } });
        ret.push(...newLine[1]);
        ...
        if (this.options.boxed)
            ret.push({ text: "│", style: { color: this.selected === 1 && row === 0 || this.selected === 3 && row === 1 ? this.options.boxColor : "white", bold: this.boxBold } });
    ...
    draw() {
        ...
        const maxPageHeight = Math.max(this.page1.getViewedPageHeight(), this.page2.getViewedPageHeight(), this.page3.getViewedPageHeight(), this.page4.getViewedPageHeight());
        const p = [
            ...
            if (this.options.boxed) { // Draw pages with borders
                if (j === 0) {
                    if (this.options.showTitle) {
                        this.CM.Screen.write({ text: `┌─${trimmedTitle[j][0]}${"─".repeat(this.realWidth[j][0] - trimmedTitle[j][0].length - 3)}┬`, style: { color: this.selected === 0 ? this.options.boxColor : "white", bold: this.boxBold } }, { text: `─${trimmedTitle[j][1]}${"─".repeat(this.realWidth[j][1] - trimmedTitle[j][1].length - 2)}┐`, style: { color: this.selected === 1 ? this.options.boxColor : "white", bold: this.boxBold } });
                    }
                    else {
                        this.CM.Screen.write({ text: `┌─${"─".repeat(this.realWidth[j][0] - 3)}┬`, style: { color: this.selected === 0 ? this.options.boxColor : "white", bold: this.boxBold } }, { text: `─${"─".repeat(this.realWidth[j][1] - 2)}┐`, style: { color: this.selected === 1 ? this.options.boxColor : "white", bold: this.boxBold } });
                    }
                }
                ...
                if (j === 0) {
                    ...
                    if (this.options.showTitle) {
                        ...
                        this.CM.Screen.write({ text: `├─${trimmedTitle[j + 1][0]}${str}`, style: { color: this.selected === 2 ? this.options.boxColor : "white", bold: this.boxBold } }, { text: `─${trimmedTitle[j + 1][1]}${str2}┤`, style: { color: this.selected === 3 ? this.options.boxColor : "white", bold: this.boxBold } });
                    }
                    else {
                        let str;
                        if (first === second)
                        ...
                        this.CM.Screen.write({ text: `├${str}`, style: { color: this.selected === 0 || this.selected === 2 ? this.options.boxColor : "white", bold: this.boxBold } }, { text: `${str2}┤`, style: { color: this.selected === 1 || this.selected === 3 ? this.options.boxColor : "white", bold: this.boxBold } });
                    }
                }
                else {
                    this.CM.Screen.write({ text: `└${"─".repeat(this.realWidth[j][0] - 2)}┴`, style: { color: this.selected === 2 ? this.options.boxColor : "white", bold: this.boxBold } }, { text: `${"─".repeat(this.realWidth[j][1] - 1)}┘`, style: { color: this.selected === 3 ? this.options.boxColor : "white", bold: this.boxBold } });
                }
            }
            else { // Draw pages without borders
                if (this.options.showTitle) {
                    if (j === 0) {
                        this.CM.Screen.write({ text: `${trimmedTitle[j][0]}${" ".repeat(this.realWidth[j][0] - trimmedTitle[j][0].length)}`, style: { color: this.selected === 0 ? this.options.boxColor : "white", bold: this.boxBold } }, { text: `${trimmedTitle[j][1]}`, style: { color: this.selected === 1 ? this.options.boxColor : "white", bold: this.boxBold } });
                    }
                    else {
                        this.CM.Screen.write({ text: `${trimmedTitle[j][0]}${" ".repeat(this.realWidth[j][0] - trimmedTitle[j][0].length)}`, style: { color: this.selected === 2 ? this.options.boxColor : "white", bold: this.boxBold } }, { text: `${trimmedTitle[j][1]}`, style: { color: this.selected === 3 ? this.options.boxColor : "white", bold: this.boxBold } });
                    }
                }
                for (let i = 0; i < maxPageHeight; i++) {
                    this.drawLine(p[j + (j * 1)][i] || [{ text: "", style: { color: "" } }], p[j + (j * 1) + 1][i] || [{ text: "", style: { color: "" } }], j);
...
exports.QuadLayout = QuadLayout;
exports.default = QuadLayout;
//# sourceMappingURL=QuadLayout.js.map