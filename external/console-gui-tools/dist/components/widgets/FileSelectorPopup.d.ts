...
import { ConsoleManager, KeyListenerArgs } from "../../ConsoleGui";
/**
...
export declare class FileSelectorPopup extends EventEmitter {
    ...
    constructor(id: string, title: string, basePath: string, selectDirectory?: boolean, allowedExtensions?: any[], limitToPath?: boolean, visible?: boolean);
    /**
